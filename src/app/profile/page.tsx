  ...
  return (
    <>
      ...
      <div className="menu-item">
        ...
        <div className="menu-item-text">Про GigaChat</div>
        <div className="menu-item-arrow">›</div>
      </div>
      ...
      <div className="menu-item">
        ...
        <div className="menu-item-text">Поделиться мнением</div>
        <div className="menu-item-arrow">›</div>
      </div>
      ...
      <div className="menu-item">
        ...
        <div className="menu-item-text">Каталог запросов</div>
        <div className="menu-item-arrow">›</div>
      </div>
      ...
      <div className="menu-item">
        ...
        <div className="menu-item-text">Написать в поддержку</div>
        <div className="menu-item-arrow">›</div>
      </div>
      ...
      <div className="menu-item">
        ...
        <div className="menu-item-text">GigaChat в веб-версии</div>
        <div className="menu-item-arrow">›</div>
      </div>
      ...
      <div className="menu-item">
        ...
        <div className="menu-item-text">GigaChat в VK</div>
        <div className="menu-item-arrow">›</div>
      </div>
